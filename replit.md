...
- **PlayerScreen Web Seek Keys**: When the seek bar is focused or captured, ArrowLeft/ArrowRight on a web/desktop keyboard seek ±10s (TV remote behaviour for Android TV is unchanged).
