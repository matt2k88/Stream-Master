...
- [Metro web platform resolution](metro-web-platform.md) — must add 'web' to resolver.platforms; Expo default omits it, breaking .web.tsx overrides on the web bundle.
