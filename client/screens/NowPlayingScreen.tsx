...
const styles = StyleSheet.create({
  ...
  queueWrap: { width: "100%", alignSelf: "stretch", paddingHorizontal: Spacing.xl, marginTop: Spacing.lg },
  queueTitle: { color: Colors.dark.text, fontSize: 14, fontWeight: "700", marginBottom: Spacing.sm },
  qRow: { width: "100%", alignSelf: "stretch", flexDirection: "row", alignItems: "center", gap: Spacing.md, paddingVertical: 6 },
